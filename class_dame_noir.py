...
class dame_noir(pygame.sprite.Sprite):
    ...
    def __init__(self,game,x,y,num):
        ...
        self.image = pygame.image.load('assets/dame_noire.png')
    ...
    def veref_pos(self,anc_pos,new_pos,plataeu):
        game = self.get_game()
    ...
    def recup_all_pos(self,pos,plateau,check_echec = True):
        ...
        for i in range(x+1,8):
            ...
            elif plateau[(i,y)] in game.all_id_blancs:
                self.ajoute_pos(plateau.copy(),x,y,i,y,check_echec)
                break
            else:
                break
        ...
        for i in range(y+1,8):
            ...
            elif plateau[(x,i)] in game.all_id_blancs:
                self.ajoute_pos(plateau.copy(),x,y,x,i,check_echec)
                break
            else:
                break
        ...
        for i in range(1,mini):
            ...
            elif plateau[(x+i,y+i)] in game.all_id_blancs:
                self.ajoute_pos(plateau.copy(),x,y,x+i,y+i,check_echec)
                break
            else:
                break
