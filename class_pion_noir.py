...
class pion_noir(pygame.sprite.Sprite):
    ...
    def __init__(self,game,x,y,num):
        ...
        self.image = pygame.image.load('assets/pion_noir.png')
    ...
    def recup_all_pos(self,pos,plateau,check_echec = True):
        ...
        if plateau.sens == 0:
            ...
            if x != 7 and y != 0:
                if plateau[(x+1,y-1)] in game.all_id_blancs:
            ...
            if y==3:
                if x != 7:
                    if game.dico_piece_id[plateau[(x+1,y)]] in game.all_pions_blancs and plateau[(x+1,y-1)] == 0:
